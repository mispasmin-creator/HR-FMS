  ...
  const fetchAttendanceData = async () => {
    ...
    try {
      const response = await fetch(
        'https://script.google.com/macros/s/AKfycbwXmzJ1VXIL4ZCKubtcsqrDcnAgxB3byiIWAC2i9Z3UVvWPaijuRJkMJxBvj3gNOBoJ/exec?sheet=Report&action=fetch'
      );
...
const getIndex = (headerName) => {
 ...
 const downloadDailyData = async (empId, name, month) => {
    ...
    try {
      const response = await fetch(
        `https://script.google.com/macros/s/AKfycbwXmzJ1VXIL4ZCKubtcsqrDcnAgxB3byiIWAC2i9Z3UVvWPaijuRJkMJxBvj3gNOBoJ/exec?sheet=Report Daily&action=fetch`
      );
